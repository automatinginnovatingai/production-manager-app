...
from CSV_File import export_to_excel

class EmployeeDailyWorkFrame(tk.Frame):
    def __init__(self, controller):
        ...
        # Define your buttons
        buttons = [
            ("Save", self.save_data, "green"),
            ("Exit", self.exit_button, "red"),
            ("Clear", self.clear_form, "blue"),
            ("Export Payroll to Excel", self.export_database, "purple"),
    ...
    def export_database(self):
        try:
            export_to_excel()
            messagebox.showinfo("Success", "Payroll exported to Excel.")
        except Exception as e:
            messagebox.showerror("Export Error", f"Could not export payroll: {e}")
